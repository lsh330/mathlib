...
from .._core.trigonometric import sin as _sin_core
...
def sin(
    ...
    complex mode: Euler's identity sin(z) = (e^iz - e^-iz) / 2i
    """
    # fast-path: 가장 일반적인 real float 호출 최적화
